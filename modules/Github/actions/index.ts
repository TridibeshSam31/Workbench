 ...
 const user = await currentUser()
  ...
  try {
    ...
    files.forEach(file => {
        ...
        const fileName = pathParts.pop()! //get the last part as file name

        let currentFolder = templateStructure.items
        let currentLevel = currentFolder
      ...
      //imp thing we have to match the repo structure to our template structure since we have limited templates 
